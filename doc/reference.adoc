...
--
+
Copy from the drawing region of __canvas~2~__ to the drawing region of __canvas~1~__,
at the drawing pos of __canvas~1~__ using the drawing mode of __canvas~1~__.
+
.Examples
```
...
```
+
See also: xref:encodeutf8[+encodeutf8+], xref:format[+format+], xref:freeze[+freeze+], xref:readfile[+readfile+], xref:string[+string+]
...
```
+
See also: xref:decodeutf8[+decodeutf8+], xref:format[+format+], xref:freeze[+freeze+], xref:readfile[+readfile+], xref:string[+string+]
...
```
+
See also: xref:decodeutf8[+decodeutf8+], xref:encodeutf8[+encodeutf8+], xref:freeze[+freeze+], xref:readfile[+readfile+], xref:string[+string+]
...
```
+
See also: xref:decodeutf8[+decodeutf8+], xref:encodeutf8[+encodeutf8+], xref:format[+format+], xref:readfile[+readfile+], xref:string[+string+]
...
+
--
** ( __canvas~1~__ -- __font~1~__ )
** ( __canvas~1~__ -- __nil__ )
+
__canvas~1~__: canvas
+
__font~1~__: font
--
+
...
+
--
** ( __canvas~1~__ -- __int~1~__ __int~2~__ __int~3~__ __int~4~__ )
+
__canvas~1~__: canvas
+
__int~1~__: x
...
```
+
See also: xref:decodeutf8[+decodeutf8+], xref:encodeutf8[+encodeutf8+], xref:format[+format+], xref:freeze[+freeze+], xref:string[+string+]
...
--
+
Set font used in canvas. If __nil__ is passed, no font will be associated with canvas.
+
.Examples
```
...
```
+
See also: xref:decodeutf8[+decodeutf8+], xref:encodeutf8[+encodeutf8+], xref:format[+format+], xref:freeze[+freeze+], xref:readfile[+readfile+]
