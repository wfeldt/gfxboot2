...
/Edit (
  ...
  /_redraw {
    ...
    buf length 0 gt {
      1 buf length 1 sub {
        /i exch ldef
        background cursor_x i get x_shift sub margin add 0 buf i get dim pop height setcregion
    ...
    background cursor_x -1 get x_shift sub margin add 0 1 tail_d sub height setcregion
